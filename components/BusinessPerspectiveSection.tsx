...
export default function BusinessPerspectiveSection() {
  ...
  className="
    ...
    w-[20%] h-[60%]
    bg-[radial-gradient(ellipse_at_top_left,rgba(90,10,10,0.7)_0%,rgba(90,10,10,0.4)_20%,rgba(90,10,10,0.15)_45%,transparent_72%)]
    blur-[25px]
    pointer-events-none
  "
/>
        ...
        <div className="grid grid-cols-12 gap-12 md:gap-20">
          ...
          <div className="w-full lg:col-span-6 flex flex-col">
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <p className="sec-top-ti text-[#fff]">
                REPUTE BUSINESS PERSPECTIVE · AUGUST 2026
              </p>
            </div>

            {/* Heading */}
            <h2 className="section-ti leading-13 text-white mb-8">
              WHAT'S CHANGING<br />IN BUSINESS.
            </h2>

            {/* Challenge label */}
            <p className="text-[10px] font-semibold tracking-[0.2em] text-white uppercase mb-3">
              THIS MONTH'S BUSINESS CHALLENGE
            </p>

            {/* Quote box */}
            <div className="mb-5">
              <h3 className="section-ti-sm leading-10 text-white ">
            ...
            <div className="relative w-full aspect-[16/9] overflow-hidden">
              ...
              <button className="absolute inset-0 flex items-center justify-center">
                <div className="w-14 h-14 rounded-full bg-[#c9181d] flex items-center justify-center shadow-lg hover:bg-[#a93226] transition-colors">
            ...
            <div className="flex items-center gap-6 mt-6">
              ...
              <button className="hero-btn hero-btn-secondary !border-none">
          ...
          {/* Right */}
          <div className="w-full lg:col-span-6  flex flex-col justify-center mt-[-20%]">
            <div className="hero-btn hero-btn-secondary w-fit py-2 px-4 mb-5 ">
              THIS MONTH
            </div>

            <div className="bg-white section-pad px-8">
              ...
              <div className="flex flex-col gap-3 mb-5">
                {sequence.map((s) => (
                  <div key={s.num} className="flex items-center gap-4 pb-3 last:border-0 last:pb-0">
                    ...
                    <p className="text-[14px] font-semibold text-black">{s.label}</p>
                  </div>
                ))}
              </div>
