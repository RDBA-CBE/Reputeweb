...
const capabilities = [
  {
    num: "01", title: "BRANDING & CREATIVE",
      ...
      <div className="section-wid py-12 md:py-16 lg:py-20">
        ...
        <div className="grid grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-10">
          <div className="w-full col-span-12 lg:col-span-7">
            ...
            <h2 className="section-ti text-white leading-tight">
        ...
        <div className=" grid grid-cols-12 gap-8 lg:gap-20">
              ...
              <div key={cap.num} className="border-t border-white/40 cursor-pointer" onClick={() => setActive(idx)}>
                <div className="py-4 md:py-5">
                  <div className="flex items-center gap-4 py-2 md:py-3">
                    <span className="text-base md:text-lg font-bold text-white">{cap.num}</span>
                  ...
                  {active === idx && (
                    <div className="mt-2 ml-8">
                      <p className="text-white text-sm md:text-base mb-3">{cap.tag}</p>
                      <div className="flex flex-wrap gap-2 w-full md:w-[80%]">
                        {cap.tags.map((tag) => (
                          <span key={tag} className="text-[13px] md:text-[14px] text-white bg-white/20 rounded-full px-3 py-1 flex items-center gap-1">
          ...
          <div className="w-full col-span-12 lg:col-span-5 flex flex-col justify-between">
            ...
            <div className="flex justify-between items-center px-1 py-3 mt-3 md:mt-4">
              <p className="text-sm md:text-base tracking-widest text-white uppercase">{capabilities[active].title}</p>
